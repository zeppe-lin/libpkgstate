...
set -- --wrap-mode=nofallback --fatal-meson-warnings --prefix="$install_prefix" --libdir=lib -Ddefault_library="$link_mode" -Dlink_mode="$link_mode" -Dtests=enabled -Dtools=enabled -Dinstall_tools=true -Dwerror=true "$@"
