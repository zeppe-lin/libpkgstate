...
retain source-authoritative package release, selected-profile, and source-snapshot identities, installed
...
Canonical generation-v4 target-binding and complete-snapshot record bytes are
