...
complete native snapshot, including complete installed object metadata and
hard-link topology retained by each receipt. Every state-owned identity is
recomputed while reading. External identities are decoded as typed references
...
Current version: 2.
Current receipt-visible identifier: `libpkgstate-generation-v2`.
