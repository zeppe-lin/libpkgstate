 ...
 *
 * The wrapper validates canonical digest representation and keeps semantic
 * domains distinct in C++.  It does not claim that libpkgstate computed or
 * authenticated the referenced object.
 */
template<typename Domain>
class referenced_digest final {
public:
  /*! \brief Construct a referenced SHA-256 identity from exact digest bytes. */
