...
[[nodiscard]] PKGSTATE_API std::string_view to_string(lifecycle_action value) noexcept;
[[nodiscard]] PKGSTATE_API std::string_view to_string(program_language value) noexcept;
...
public:
  ...
  [[nodiscard]] const std::string& name() const noexcept;
  friend PKGSTATE_API bool operator==(const architecture_reference& lhs,
...
public:
  ...
  friend PKGSTATE_API bool operator==(const declaration_provenance& lhs,
...
public:
  ...
  friend PKGSTATE_API bool operator==(const profile_expansion_step& lhs,
...
public:
  ...
  friend PKGSTATE_API bool operator==(const program& lhs, const program& rhs) noexcept;
  friend PKGSTATE_API bool operator!=(const program& lhs, const program& rhs) noexcept;
  friend PKGSTATE_API bool operator<(const program& lhs, const program& rhs) noexcept;
private:
...
public:
  ...
  friend PKGSTATE_API bool operator==(const lifecycle_requirement& lhs,
